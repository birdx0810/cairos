  ...
  <div class="h-full">
    <div class="bg-white/80 backdrop-blur rounded-lg p-4 border border-gray-200/50 shadow-sm h-full">
      ...
      <div class="overflow-y-auto max-h-[600px] custom-scrollbar">
        <div v-if="summaryData.length === 0" class="text-center py-12">
          <div class="flex flex-col items-center gap-3">
            <div class="w-16 h-16 bg-gradient-to-br from-green-100 to-blue-100 rounded-full flex items-center justify-center">
            </div>
        ...
        <div v-else class="space-y-4">
          ...
          >
            <div class="flex items-center justify-between mb-3">
              <h3 class="font-semibold text-gray-800 truncate flex-1 mr-2">
                {{ summary.plan || 'Unnamed Plan' }}
              </h3>
              <div
                :class="[
                  'text-lg font-bold px-2 py-1 rounded-lg text-center min-w-[60px]',
            ...
            <div class="space-y-2 text-sm text-gray-600">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-mono">{{ summary.startTime }} - {{ summary.endTime }}</span>
              </div>
              <div class="flex justify-between">
